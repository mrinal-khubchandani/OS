...
int main (int argc,char *argv[]){
  ...
  1d:	6a 01                	push   $0x1
  1f:	e8 ac 04 00 00       	call   4d0 <printf>
    int su=0;
  ...
  2a:	7f 71                	jg     9d <main+0x9d>
    for(int i=0;i<64;i++){
  2c:	31 db                	xor    %ebx,%ebx
  2e:	8d 75 c4             	lea    -0x3c(%ebp),%esi
  31:	eb 0d                	jmp    40 <main+0x40>
  33:	90                   	nop
  34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  38:	83 c3 01             	add    $0x1,%ebx
  3b:	83 fb 40             	cmp    $0x40,%ebx
  3e:	74 58                	je     98 <main+0x98>
        if(getpinfo(i,p)==0){
  40:	83 ec 08             	sub    $0x8,%esp
  43:	56                   	push   %esi
  44:	53                   	push   %ebx
  45:	e8 c8 03 00 00       	call   412 <getpinfo>
  4a:	83 c4 10             	add    $0x10,%esp
  4d:	85 c0                	test   %eax,%eax
  4f:	75 e7                	jne    38 <main+0x38>
  ...
  5a:	ff 75 dc             	pushl  -0x24(%ebp)
  5d:	ff 75 d8             	pushl  -0x28(%ebp)
    for(int i=0;i<64;i++){
  60:	83 c3 01             	add    $0x1,%ebx
            printf(1,"PID: %d | RUNTIME: %d | NUM_RUN: %d | CURRENT_QUEUE: %d |  %d %d %d %d %d",
  63:	ff 75 d4             	pushl  -0x2c(%ebp)
  66:	ff 75 d0             	pushl  -0x30(%ebp)
  69:	ff 75 cc             	pushl  -0x34(%ebp)
  6c:	ff 75 c8             	pushl  -0x38(%ebp)
  6f:	ff 75 c4             	pushl  -0x3c(%ebp)
  72:	68 58 08 00 00       	push   $0x858
  77:	6a 01                	push   $0x1
  79:	e8 52 04 00 00       	call   4d0 <printf>
            p->pid,p->runtime,p->num_run,p->current_queue,p->ticks[0],p->ticks[1],p->ticks[2],p->ticks[3],p->ticks[4]);
            printf(1,"\n");
  7e:	83 c4 28             	add    $0x28,%esp
  81:	68 3e 08 00 00       	push   $0x83e
  86:	6a 01                	push   $0x1
  88:	e8 43 04 00 00       	call   4d0 <printf>
  8d:	83 c4 10             	add    $0x10,%esp
    for(int i=0;i<64;i++){
  90:	83 fb 40             	cmp    $0x40,%ebx
  ...
  a0:	ff 76 04             	pushl  0x4(%esi)
  a3:	e8 48 02 00 00       	call   2f0 <atoi>
  a8:	59                   	pop    %ecx
  a9:	8d 55 c4             	lea    -0x3c(%ebp),%edx
  ac:	5b                   	pop    %ebx
  ad:	52                   	push   %edx
  ae:	50                   	push   %eax
  af:	e8 5e 03 00 00       	call   412 <getpinfo>
  b4:	83 c4 10             	add    $0x10,%esp
  b7:	85 c0                	test   %eax,%eax
  b9:	75 3c                	jne    f7 <main+0xf7>
            printf(1,"PID: %d | RUNTIME: %d | NUM_RUN: %d | CURRENT_QUEUE: %d |  %d %d %d %d %d",
  bb:	52                   	push   %edx
  bc:	ff 75 e4             	pushl  -0x1c(%ebp)
  bf:	ff 75 e0             	pushl  -0x20(%ebp)
  c2:	ff 75 dc             	pushl  -0x24(%ebp)
  c5:	ff 75 d8             	pushl  -0x28(%ebp)
  c8:	ff 75 d4             	pushl  -0x2c(%ebp)
  cb:	ff 75 d0             	pushl  -0x30(%ebp)
  ce:	ff 75 cc             	pushl  -0x34(%ebp)
  d1:	ff 75 c8             	pushl  -0x38(%ebp)
  d4:	ff 75 c4             	pushl  -0x3c(%ebp)
  d7:	68 58 08 00 00       	push   $0x858
  dc:	6a 01                	push   $0x1
  de:	e8 ed 03 00 00       	call   4d0 <printf>
            printf(1,"\n");
  e3:	83 c4 28             	add    $0x28,%esp
  e6:	68 3e 08 00 00       	push   $0x83e
  eb:	6a 01                	push   $0x1
  ed:	e8 de 03 00 00       	call   4d0 <printf>
  f2:	83 c4 10             	add    $0x10,%esp
  f5:	eb a1                	jmp    98 <main+0x98>
            printf(1,"Process does not exist\n");
  f7:	50                   	push   %eax
  f8:	50                   	push   %eax
  f9:	68 40 08 00 00       	push   $0x840
  fe:	6a 01                	push   $0x1
 100:	e8 cb 03 00 00       	call   4d0 <printf>
 ...
 439:	85 d2                	test   %edx,%edx
{
 ...
 467:	f7 f1                	div    %ecx
 469:	0f b6 92 ac 08 00 00 	movzbl 0x8ac(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 684:	e9 8f fe ff ff       	jmp    518 <printf+0x48>
          s = "(null)";
 689:	bb a4 08 00 00       	mov    $0x8a4,%ebx
        while(*s != 0){

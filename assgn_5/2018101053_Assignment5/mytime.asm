...
_mytime:     file format elf32-i386
...
int main (int argc,char *argv[]){
  ...
  39:	75 37                	jne    72 <main+0x72>
  		exec(argv[1], argv);
  3b:	52                   	push   %edx
  3c:	52                   	push   %edx
  3d:	53                   	push   %ebx
  3e:	ff 73 04             	pushl  0x4(%ebx)
  41:	e8 d4 02 00 00       	call   31a <exec>
    	printf(1, "exec %s failed\n", argv[1]);
  46:	83 c4 0c             	add    $0xc,%esp
  49:	ff 73 04             	pushl  0x4(%ebx)
  4c:	68 b0 07 00 00       	push   $0x7b0
  51:	6a 01                	push   $0x1
  ...
  5b:	ff 75 f4             	pushl  -0xc(%ebp)
  5e:	ff 75 f0             	pushl  -0x10(%ebp)
  61:	68 c0 07 00 00       	push   $0x7c0
  66:	6a 01                	push   $0x1
  ...
  72:	50                   	push   %eax
  73:	50                   	push   %eax
  74:	8d 45 f4             	lea    -0xc(%ebp),%eax
  77:	50                   	push   %eax
  78:	8d 45 f0             	lea    -0x10(%ebp),%eax
  7b:	50                   	push   %eax
  7c:	e8 01 03 00 00       	call   382 <waitx>
  81:	83 c4 10             	add    $0x10,%esp
  84:	eb d5                	jmp    5b <main+0x5b>
  86:	66 90                	xchg   %ax,%ax
  88:	66 90                	xchg   %ax,%ax
  8a:	66 90                	xchg   %ax,%ax
  8c:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb e0 07 00 00       	mov    $0x7e0,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 621:	a1 90 0a 00 00       	mov    0xa90,%eax
{
 ...
 65d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 65f:	a3 90 0a 00 00       	mov    %eax,0xa90
}
 664:	5b                   	pop    %ebx
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
 ...
 676:	72 ce                	jb     646 <free+0x26>
{
 ...
 697:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 69a:	a3 90 0a 00 00       	mov    %eax,0xa90
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 15 90 0a 00 00    	mov    0xa90,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 47                	jae    748 <malloc+0x98>
    ...
    if(p == freep)
 701:	39 05 90 0a 00 00    	cmp    %eax,0xa90
 ...
 726:	e8 f5 fe ff ff       	call   620 <free>
  return freep;
 72b:	8b 15 90 0a 00 00    	mov    0xa90,%edx
 ...
 754:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 757:	89 15 90 0a 00 00    	mov    %edx,0xa90
}
 ...
 777:	0a 00 00 
 77a:	c7 05 94 0a 00 00 94 	movl   $0xa94,0xa94
 781:	0a 00 00 
    base.s.size = 0;
 784:	b8 94 0a 00 00       	mov    $0xa94,%eax
 789:	c7 05 98 0a 00 00 00 	movl   $0x0,0xa98
 790:	00 00 00 

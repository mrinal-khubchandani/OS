...
main(void)
{
  ...
  3f:	58                   	pop    %eax
  40:	5a                   	pop    %edx
  41:	68 10 08 00 00       	push   $0x810
  46:	6a 01                	push   $0x1
  48:	e8 63 04 00 00       	call   4b0 <printf>
  ...
  ab:	68 48 08 00 00       	push   $0x848
  b0:	e8 c5 02 00 00       	call   37a <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  b7:	68 4b 08 00 00       	push   $0x84b
  bc:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
 ...
 664:	e9 8f fe ff ff       	jmp    4f8 <printf+0x48>
          s = "(null)";
 669:	bb 6a 08 00 00       	mov    $0x86a,%ebx
        while(*s != 0){

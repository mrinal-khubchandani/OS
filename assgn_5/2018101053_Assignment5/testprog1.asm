...
_testprog1:     file format elf32-i386
...
int main (int argc,char *argv[]){
  ...
  12:	8d 75 c4             	lea    -0x3c(%ebp),%esi
int main (int argc,char *argv[]){
  15:	83 ec 44             	sub    $0x44,%esp
    printf(1,"PS TEST PROGRAM CALLED\n");
  18:	68 b8 07 00 00       	push   $0x7b8
  1d:	6a 01                	push   $0x1
  1f:	e8 3c 04 00 00       	call   460 <printf>
  24:	83 c4 10             	add    $0x10,%esp
  27:	eb 0f                	jmp    38 <main+0x38>
  29:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    for(int i=0;i<10;i++){
  30:	83 c3 01             	add    $0x1,%ebx
  33:	83 fb 0a             	cmp    $0xa,%ebx
  36:	74 55                	je     8d <main+0x8d>
        if(getpinfo(i,p)==0){
  38:	83 ec 08             	sub    $0x8,%esp
  3b:	56                   	push   %esi
  3c:	53                   	push   %ebx
  3d:	e8 60 03 00 00       	call   3a2 <getpinfo>
  42:	83 c4 10             	add    $0x10,%esp
  45:	85 c0                	test   %eax,%eax
  47:	75 e7                	jne    30 <main+0x30>
            printf(1,"PID: %d | RUNTIME: %d | NUM_RUN: %d | CURRENT_QUEUE: %d |  %d %d %d %d %d",
  49:	83 ec 04             	sub    $0x4,%esp
  4c:	ff 75 e4             	pushl  -0x1c(%ebp)
  4f:	ff 75 e0             	pushl  -0x20(%ebp)
  52:	ff 75 dc             	pushl  -0x24(%ebp)
  55:	ff 75 d8             	pushl  -0x28(%ebp)
    for(int i=0;i<10;i++){
  58:	83 c3 01             	add    $0x1,%ebx
            printf(1,"PID: %d | RUNTIME: %d | NUM_RUN: %d | CURRENT_QUEUE: %d |  %d %d %d %d %d",
  5b:	ff 75 d4             	pushl  -0x2c(%ebp)
  5e:	ff 75 d0             	pushl  -0x30(%ebp)
  61:	ff 75 cc             	pushl  -0x34(%ebp)
  64:	ff 75 c8             	pushl  -0x38(%ebp)
  67:	ff 75 c4             	pushl  -0x3c(%ebp)
  6a:	68 d0 07 00 00       	push   $0x7d0
  6f:	6a 01                	push   $0x1
  71:	e8 ea 03 00 00       	call   460 <printf>
            ...
            printf(1,"\n");
  76:	83 c4 28             	add    $0x28,%esp
  79:	68 ce 07 00 00       	push   $0x7ce
  7e:	6a 01                	push   $0x1
  80:	e8 db 03 00 00       	call   460 <printf>
  85:	83 c4 10             	add    $0x10,%esp
    for(int i=0;i<10;i++){
  88:	83 fb 0a             	cmp    $0xa,%ebx
  8b:	75 ab                	jne    38 <main+0x38>
...
printf(int fd, const char *fmt, ...)
{
 ...
 614:	e9 8f fe ff ff       	jmp    4a8 <printf+0x48>
          s = "(null)";
 619:	bb 1c 08 00 00       	mov    $0x81c,%ebx
        while(*s != 0){
 ...
 631:	a1 e0 0a 00 00       	mov    0xae0,%eax
{
 ...
 66d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 66f:	a3 e0 0a 00 00       	mov    %eax,0xae0
}
 674:	5b                   	pop    %ebx
 675:	5e                   	pop    %esi
 676:	5f                   	pop    %edi
 ...
 686:	72 ce                	jb     656 <free+0x26>
{
 ...
 6a7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6aa:	a3 e0 0a 00 00       	mov    %eax,0xae0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 70f:	73 47                	jae    758 <malloc+0x98>
    ...
    if(p == freep)
 711:	39 05 e0 0a 00 00    	cmp    %eax,0xae0
 ...
 736:	e8 f5 fe ff ff       	call   630 <free>
  return freep;
 73b:	8b 15 e0 0a 00 00    	mov    0xae0,%edx
 ...
 764:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 767:	89 15 e0 0a 00 00    	mov    %edx,0xae0
}
 ...
 779:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 780:	c7 05 e0 0a 00 00 e4 	movl   $0xae4,0xae0
 787:	0a 00 00 
 78a:	c7 05 e4 0a 00 00 e4 	movl   $0xae4,0xae4
 791:	0a 00 00 
    base.s.size = 0;
 794:	b8 e4 0a 00 00       	mov    $0xae4,%eax
 799:	c7 05 e8 0a 00 00 00 	movl   $0x0,0xae8
 7a0:	00 00 00 

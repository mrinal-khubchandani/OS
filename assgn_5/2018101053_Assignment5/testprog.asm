...
int main (int argc,char *argv[]){
  ...
  1b:	3d 3f 0d 03 00       	cmp    $0x30d3f,%eax
  20:	7f 4a                	jg     6c <main+0x6c>
  ...
  32:	3d 1f 4e 00 00       	cmp    $0x4e1f,%eax
  37:	7f 20                	jg     59 <main+0x59>
  39:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  40:	8b 45 f4             	mov    -0xc(%ebp),%eax
  43:	8b 45 f0             	mov    -0x10(%ebp),%eax
  46:	8b 45 f4             	mov    -0xc(%ebp),%eax
  49:	83 c0 01             	add    $0x1,%eax
  4c:	89 45 f4             	mov    %eax,-0xc(%ebp)
  4f:	8b 45 f4             	mov    -0xc(%ebp),%eax
  52:	3d 1f 4e 00 00       	cmp    $0x4e1f,%eax
  57:	7e e7                	jle    40 <main+0x40>
    for(volatile int j=0;j<200000;j++){
  59:	8b 45 f0             	mov    -0x10(%ebp),%eax
  5c:	83 c0 01             	add    $0x1,%eax
  5f:	89 45 f0             	mov    %eax,-0x10(%ebp)
  62:	8b 45 f0             	mov    -0x10(%ebp),%eax
  65:	3d 3f 0d 03 00       	cmp    $0x30d3f,%eax
  6a:	7e bc                	jle    28 <main+0x28>
    }
    exit();
  6c:	e8 61 02 00 00       	call   2d2 <exit>
  71:	66 90                	xchg   %ax,%ax
  73:	66 90                	xchg   %ax,%ax
  75:	66 90                	xchg   %ax,%ax
  77:	66 90                	xchg   %ax,%ax

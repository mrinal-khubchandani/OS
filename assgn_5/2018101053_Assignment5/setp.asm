...
int main (int argc,char *argv[]){
  16:	8b 59 04             	mov    0x4(%ecx),%ebx
    if(argc<3) printf(1,"enter 2 arguments");
  19:	7e 52                	jle    6d <main+0x6d>
    int pid = atoi(argv[1]);
  1b:	83 ec 0c             	sub    $0xc,%esp
  1e:	ff 73 04             	pushl  0x4(%ebx)
  21:	e8 3a 02 00 00       	call   260 <atoi>
  26:	89 c6                	mov    %eax,%esi
    int prio = atoi(argv[2]);
  28:	58                   	pop    %eax
  29:	ff 73 08             	pushl  0x8(%ebx)
  2c:	e8 2f 02 00 00       	call   260 <atoi>
    if(prio<0||prio>100){
  31:	83 c4 10             	add    $0x10,%esp
  34:	83 f8 64             	cmp    $0x64,%eax
    int prio = atoi(argv[2]);
  37:	89 c3                	mov    %eax,%ebx
    if(prio<0||prio>100){
  39:	76 16                	jbe    51 <main+0x51>
        printf(1,"invalid priority\n");
  3b:	51                   	push   %ecx
  3c:	51                   	push   %ecx
  3d:	68 aa 07 00 00       	push   $0x7aa
  42:	6a 01                	push   $0x1
  ...
  49:	83 c4 10             	add    $0x10,%esp
    ...
    exit();
  4c:	e8 81 02 00 00       	call   2d2 <exit>
        printf(1,"SETTING PRIORITY OF %d TO %d\n",pid,prio);
  51:	50                   	push   %eax
  52:	56                   	push   %esi
  ...
  61:	53                   	push   %ebx
  62:	56                   	push   %esi
  63:	e8 12 03 00 00       	call   37a <set_priority>
  68:	83 c4 10             	add    $0x10,%esp
  6b:	eb df                	jmp    4c <main+0x4c>
    if(argc<3) printf(1,"enter 2 arguments");
  6d:	50                   	push   %eax
  6e:	50                   	push   %eax
  6f:	68 98 07 00 00       	push   $0x798
  74:	6a 01                	push   $0x1
  76:	e8 c5 03 00 00       	call   440 <printf>
  7b:	83 c4 10             	add    $0x10,%esp
  7e:	eb 9b                	jmp    1b <main+0x1b>
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
          s = "(null)";
 5f9:	bb da 07 00 00       	mov    $0x7da,%ebx
        while(*s != 0){
